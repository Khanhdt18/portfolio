...
quadratic_retail = PolynomialFeatures(degree=2)

X_quad_train = quadratic_retail.fit_transform(X_train_std)
X_quad_test = quadratic_retail.transform(X_test_std)


#Fitting model with trainig data
lrg.fit(X_quad_train, y_train_std)
...
pickle.dump(quadratic_retail, open('quadratic_retail.pkl','wb'))
